...
from models.mot.experimental import attempt_load
...
from core.mot.torch_utils import select_device, time_synchronized
...
def test(data,
    ...
    if not training:
        ...
        dataloader = create_dataloader(path, imgsz, batch_size, model.stride.max(), opt,
                                       hyp=None, augment=False, cache=False, pad=0.5, rect=True,state="test")[0]
