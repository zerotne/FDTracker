...
from tracker.fdtrack import JDETracker
...
from dataset.fdtrack import LoadImages_jde
...
def main(opt, data_root='/data/MOT16/train', det_root=None, seqs=('MOT16-05',), exp_name='demo',
    ...
    for seq in seqs:
        ...
        dataloader = LoadImages_jde(osp.join(data_root, seq, 'img1'), opt.img_size,opt.val_hf) #用jde方式加载数据的类，
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vis_state', type=int, default=1, help='1 for vision or heatmap and reid')#

    parser.add_argument('--weights',type=str, default='../weights/last_mot_test1711.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--data_dir', type=str, default='../../../dataset/MOT/')
    parser.add_argument('--device', default='3',help='-1 for CPU, use comma for multiple gpus')
